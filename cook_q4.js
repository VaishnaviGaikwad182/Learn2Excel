const questions = [
    {
        question: "Which staple dish is commonly associated with South Indian cuisine?",
        options: ["Butter Chicken", "Dhokla", "Idli", "Rogan Josh"],
        answer: 2
    },
    {
        question: "What is a famous Gujarati sweet dish from West India?",
        options: ["Jalebi", "Basundi", "Modak", "Thekua"],
        answer: 1
    },
    {
        question: "What is the main ingredient in the Rajasthani dish 'Dal Baati'?",
        options: ["Rice", "Wheat Flour", "Chickpeas", "Corn Flour"],
        answer: 1
    },
    {
        question: "Which state is known for its seafood-based dishes like Fish Curry and Prawn Balchão?",
        options: ["Kerala", "Goa", "West Bengal", "Punjab"],
        answer: 1
    },
    {
        question: "Which street food is famous in Mumbai as a quick and spicy snack?",
        options: ["Samosa", "Vada Pav", "Dabeli", "Poha"],
        answer: 1
    }
];
