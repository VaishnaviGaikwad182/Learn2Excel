const questions = [
    {
        question: "Which spice gives Indian curries their yellow color?",
        options: ["Cumin", "Turmeric", "Coriander", "Cardamom"],
        answer: 1
    },
    {
        question: "Which cooking technique involves frying whole spices in oil or ghee to release their flavors?",
        options: ["Boiling", "Steaming", "Tempering (Tadka)", "Baking"],
        answer: 2
    },
    {
        question: "Which ingredient is commonly used to make Indian yogurt-based drinks like lassi?",
        options: ["Milk", "Curd", "Coconut Water", "Almond Milk"],
        answer: 1
    },
    {
        question: "What is the purpose of a masala dabba in Indian cooking?",
        options: ["To store lentils", "To store vegetables", "To store spices", "To store rice"],
        answer: 2
    },
    {
        question: "Which spice is commonly used in Indian tea (chai) for its strong aroma?",
        options: ["Clove", "Cardamom", "Nutmeg", "Fenugreek"],
        answer: 1
    }
];
