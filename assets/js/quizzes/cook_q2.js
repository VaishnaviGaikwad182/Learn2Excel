const questions = [
    {
        question: "Which type of rice is commonly used for making biryani?",
        options: ["Sona Masoori", "Basmati", "Parboiled Rice", "Brown Rice"],
        answer: 1
    },
    {
        question: "Which Indian bread is typically made without oil or butter?",
        options: ["Paratha", "Bhatura", "Roti", "Puri"],
        answer: 2
    },
    {
        question: "Which Indian bread is typically stuffed with spiced potatoes?",
        options: ["Naan", "Aloo Paratha", "Missi Roti", "Kulcha"],
        answer: 1
    },
    {
        question: "Which Indian rice dish is often made with ghee, cumin, and basmati rice?",
        options: ["Khichdi", "Pulao", "Jeera Rice", "Curd Rice"],
        answer: 2
    },
    {
        question: "What is the primary ingredient in Bhakri, a traditional Maharashtrian flatbread?",
        options: ["Rice Flour", "Maida", "Wheat Flour", "Jowar or Bajra Flour"],
        answer: 3
    }
];
