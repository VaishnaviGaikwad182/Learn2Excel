const questions = [
    {
        question: "Which ingredient is commonly used to make traditional Indian pickles?",
        options: ["Vinegar", "Mustard Oil", "Soy Sauce", "Coconut Milk"],
        answer: 1
    },
    {
        question: "What is the main ingredient in a classic Indian raita?",
        options: ["Milk", "Curd (Yogurt)", "Cream", "Butter"],
        answer: 1
    },
    {
        question: "What cooling ingredient is often added to raita to balance spicy food?",
        options: ["Chili Powder", "Cucumber", "Black Pepper", "Ghee"],
        answer: 1
    },
    {
        question: "Which fruit is commonly pickled in India apart from mango?",
        options: ["Papaya", "Lemon", "Banana", "Apple"],
        answer: 1
    },
    {
        question: "Which chutney is popular in Maharashtra and is made with roated peanuts, garlic, and red chili powder?",
        options: ["Green Chutney", "Peanut Chutney", "Dry Garlic Chutney", "Mint Chutney"],
        answer: 1
    }
];
