...
const questions = [
    {
        question: "What should be the first step when treating a minor cut or scrape while farming?",
        options: [
            "Apply ointment immediately",
            "Cover with cloth",
            "Clean the wound with water",
            "Tie tightly to stop bleeding"
        ],
        answer: 2
    },
    {
        question: "What is the recommended action after an insect bite causes swelling?",
        options: [
            "Scratch the area",
    ...
    {
        question: "Which condition can occur due to prolonged exposure to sun while gardening?",
        options: [
            "Hypothermia",
            "Sunburn",
            "Fungal infection",
    ...
    {
        question: "What is the best immediate response to pesticide exposure on the skin?",
        options: [
            "Apply oil",
            "Wait for symptoms",
    ...
    {
        question: "Why is keeping tetanus vaccination up to date important for farmers?",
        options: [
            "To prevent insect bites",
            "To avoid sunburn",
            "To protect against wound infections",
            "To improve immunity to colds"
        ],
        answer: 2
    }
];
