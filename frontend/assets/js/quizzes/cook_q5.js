...
const questions = [
  {
    question: "Which street food consists of hollow puris filled with spicy water?",
  ...
  {
    question: "Which snack is made with puffed rice and chutneys?",
    options: ["Bhel", "Manchurian", "Dhokla", "Samosa"],
    answer: 0,
  },
  {
    question: "Which Indo-Chinese snack uses fried cauliflower?",
    options: ["Chow Mein", "Hakka Noodles", "Flower Manchurian", "Spring Rolls"],
    answer: 2,
  },
  {
    question: "Which snack is deep-fried with spicy potato filling?",
