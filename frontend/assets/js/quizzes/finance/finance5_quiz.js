...
const questions = [
  {
    ...
    options: ["Dining out", "Groceries", "Rent", "Movie tickets"],
    answer: 2
  },
  {
    question: "Which method is NOT a recommended way to track expenses?",
    options: [
  ...
  {
    question: "What is a good strategy for reducing unnecessary expenses?",
    options: [
  ...
  },
  {
    ...
    options: [
      "Saving all money in a fixed deposit",
      "Storing bills in envelopes",
      "Allocating cash into envelopes for each expense category",
      "Mailing your expenses to your accountant"
    ],
    answer: 2
  },
  {
    ...
    options: [
      ...
      "To invest in stocks",
      "To cover unexpected financial crises",
      "To buy electronics on EMI"
    ],
    answer: 2
  },
  {
    question: "Which of the following is a Smart Spending Habit?",
    options: [
      "Buy on impulse",
      "Compare prices before purchasing",
      "Spend without checking balance",
      "Ignore discounts and cashback offers"
    ],
    answer: 1
  },
];
